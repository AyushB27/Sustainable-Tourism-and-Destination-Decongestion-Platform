...
|---|---|:---:|---|---|
| **33** | **Edge FASTag IoT ANPR Streaming** | HIGH | Sprint 6 | Real-time vehicle counts from highway toll plazas via MQTT |
| **34** | **Distributed Redis Caching Layer** | MEDIUM | Sprint 7 | Multi-node caching & pub/sub advisory streaming |
| **35** | **CDAC / NIC SMS & WhatsApp Alerts** | HIGH | Sprint 6 | Automated emergency SMS to tourists in geofenced red zones |
| **36** | **PostgreSQL & PostGIS Cloud DB** | MEDIUM | Sprint 8 | Spatial indexing and high-concurrency cloud persistence |
| **37** | **Real FASTag Inflow Data Integration** | HIGH | Sprint 6 | Replace TomTom heuristic with NHAI FASTag vehicle count APIs |
| **38** | **Gemini API Integration for AI Chat** | HIGH | Sprint 5 | Replace keyword-matching chat with Gemini API + telemetry grounding |
| **39** | **WebSocket Real-Time Push** | MEDIUM | Sprint 7 | Replace 25s polling with WebSocket for instant advisory push |
