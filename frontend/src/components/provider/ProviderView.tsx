      ...
      <div className="bg-white rounded-xl border-2 border-slate-300 p-4 sm:p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <span className="bg-amber-100 text-amber-950 border border-amber-300 text-[10px] font-bold px-2 py-0.5 rounded uppercase tracking-wider">
                MTDC अधिकृत प्रदाता पोर्टल | Accredited Operator Console
              </span>
        ...
        <div className="flex items-center gap-3 self-start md:self-auto">
          ...
          <select
            ...
            className="bg-slate-50 border-2 border-slate-300 hover:border-gov-navy focus:border-gov-navy rounded-lg px-3.5 py-2 text-xs font-bold text-slate-900 focus:outline-none transition cursor-pointer shadow-inner"
          >
            {destinations.map((d) => (
