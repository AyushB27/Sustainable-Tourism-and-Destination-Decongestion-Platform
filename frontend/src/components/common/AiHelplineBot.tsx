      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Chatbot Header */}
            <div className="bg-gov-navy text-white p-3.5 sm:p-4 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-amber-50 text-gov-navy font-bold text-lg flex items-center justify-center border border-gov-gold shrink-0">
                  🤖
                </div>
                <div>
                  <h4 className="font-extrabold text-sm sm:text-base leading-tight text-white flex items-center gap-1.5">
                    <span>24x7 AI Tourism Helpline</span>
                  </h4>
                  <p className="text-[10px] text-slate-300 flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 inline-block" />
                    Ministry of Tourism Intelligent Assistant
                  </p>
                </div>
              </div>
